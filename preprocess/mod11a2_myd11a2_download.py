...
Execution:
    ...
    python mod11a2_myd11a2_download.py %Y%m%d %Y%m%d
"""
import os
import sys
import json
...
def main(args):
    ...
    print(f"Executing `mod11a2_myd11a2_download.py` with arguments: `{args[0]}`, `{args[1]}`.")
    ...
    pathTypes = ["MOLT", "MOLA"]
    productTypes = ["MOD11A2.061", "MYD11A2.061"]
